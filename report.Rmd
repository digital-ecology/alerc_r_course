...
Below is an interactive wembap of the species records.
...
The mean are of the SACS is `r round(mean(sacd$area_ha), 2)` hectares, with a range of `r round(range(sacd$area_ha), 2)` hectares.  The largest SAC has an area of `r round(max(sacd$area_ha), 2)` hectares and the smallest `r round(min(sacd$area_ha), 2)` hectares.
